    ...
    if (isset($_FILES['pdf_document']) && $_FILES['pdf_document']['error'] == UPLOAD_ERR_OK) {
        ...
        if ($file_type == 'application/pdf') {
            if (move_uploaded_file($_FILES['pdf_document']['tmp_name'], $upload_file)) {
                ...
                $query = "INSERT INTO autoloan_applications (name, nic, phone, address, income, occupation, loan_amount, g1, g2, loan_purpose, vehicle_details, pdf_document)
                          VALUES ('$name', '$nic', '$phone', '$address', '$income', '$occupation', '$loan_amount', '$g1', '$g2', '$loan_purpose', '$vehicle_details', '$upload_file')";
